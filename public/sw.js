...
const VERSION = "v11-opfs-prefetch";
const SHELL_CACHE = `latexgen-shell-${VERSION}`;
const VENDOR_CACHE = `latexgen-vendor-${VERSION}`;
const SCOPE = new URL("./", location.href).pathname;
const SHELL = ["./", "index.html", "style.css", "app.js", "config.js", "validator.js", "qwen3-webllm.js", "webllm-store.js", "webllm-worker.js", "onnx-worker.js", "texo-webnn.js", "texify-webnn.js", "intellitex-webnn.js", "models.js", "pipeline.js", "manifest.webmanifest", "benchmarks.html"];
